...
class MainHandler(webapp2.RequestHandler):
    def get(self):
        ...
        fortune_sentence = "<p>Your fortune is: " + fortune + "</p>"

        lucky_number = "<strong>" + str(random.randint(1, 100)) + "</strong>"
        number_sentence = '<p>Your lucky number is: ' + lucky_number + '</p>'

        another_cookie = "<a href='.'><button>Another Cookie Plz!</button></a>"

        content = header + fortune_sentence + number_sentence + another_cookie
